...
class AnotherWindow(QWidget):
    ...
    """
    def __init__(self,image_path='D:/Downloads/www.facebook.com/104167876_1399187816933067_6082057024147341996_n.jpg', x=0,y=0,w=10,h=10 ):
        super().__init__()
        layout = QVBoxLayout()
        self.label = QLabel("Another Window ")
        # self.setGeometry(10, 10, 100, 60)
        # img=cv2.imread('D:/Downloads/www.facebook.com/104167876_1399187816933067_6082057024147341996_n.jpg')
        # pixmap=QImage.loadFromData(img)
        pixmap = QPixmap('D:/Downloads/www.facebook.com/104167876_1399187816933067_6082057024147341996_n.jpg')
        pixmap = pixmap.copy(x,y,w,h)
        self.resize(pixmap.width(),pixmap.height())
        # pixmap_m=QPixmap.transformed(pixmap,img.shape[0],img.shape[1])
    ...
    def mousePressEvent(self, ev):
        ...
        if ev.button() == Qt.LeftButton:
            if self.drawing():
                ...
                # this point will fix to add new function
